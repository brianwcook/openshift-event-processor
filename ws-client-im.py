...
#     print (message)
     ...
     manifestJson=json.loads(responseDict['object']['dockerImageManifest'])     
     tag=manifestJson['tag']
#     print (tag)
     digestUrl=responseDict['object']['dockerImageReference']
     print ("Received " + digestUrl)
     print("Received tag " + tag)
     
     if tag != "latest" and tag != "":
       # tell jenkins to scan the image
       response = urllib.request.urlopen('http://localhost:8080/job/process_digest/buildWithParameters?digestUrl=' + digestUrl )
...
if __name__ == "__main__":
	...
	url="https://localhost:8443/oapi/v1/images"
...
#	print (responseJson)
	...
	ws = websocket.WebSocketApp("wss://localhost:8443/oapi/v1/images?watch=true&resourceVersion=" + resourceVersion,
